...
public class ExampleGameCanvas extends GameCanvas implements Runnable {
	...
	// switch tile delay, switch tile after this delay
	private int switchTileDelay;
	...
	private TiledLayer initBackground() throws Exception {
		Image tileImages = Image.createImage("/tilesmap.png");
